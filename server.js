...
function makeServer(name = 'freithcord', options = {}) {
...
<title>freithcord</title>
<style>
:root{
  --bg0:#090a0d;--bg1:#111318;--bg2:#191c22;--bg3:#22262e;--bg4:#2b303a;
  --line:#343a46;--text:#f4f6f8;--muted:#b1b7c2;--low:#7e8796;
  --coral:#8b5cf6;--coral2:#a78bfa;--mint:#8b5cf6;--mintbg:#241b3d;--danger:#df4c4c;
  font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;
}

html[data-theme="purple"]{
  --bg0:#0f0b18;--bg1:#171022;--bg2:#211730;--bg3:#2b1e3f;--bg4:#36274d;
  --line:#49355f;--text:#faf7ff;--muted:#cabde0;--low:#9787b2;
  --coral:#9b6cff;--coral2:#b794ff;--mint:#a879ff;--mintbg:#2a1b47;--danger:#e2556b;
}

html[data-theme="white"]{
  --bg0:#edf1f6;--bg1:#ffffff;--bg2:#f5f7fa;--bg3:#e8edf3;--bg4:#dde4ec;
  --line:#ccd5df;--text:#171a20;--muted:#4f5966;--low:#7a8593;
  --coral:#536dfe;--coral2:#6f83ff;--mint:#4169e1;--mintbg:#e4eaff;--danger:#c93643;
}

html[data-theme="black"]{
  --bg0:#050506;--bg1:#0c0c0e;--bg2:#151518;--bg3:#1e1e22;--bg4:#29292e;
  --line:#36363d;--text:#f5f5f6;--muted:#b6b6bd;--low:#7b7b85;
  --coral:#e7e7eb;--coral2:#ffffff;--mint:#bfc3cb;--mintbg:#202126;--danger:#e24b58;
}
...
.themeChoices{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:8px}
.themeChoice{
...
.themeChoice:hover{transform:translateY(-1px);border-color:var(--muted)}
.themeChoice.active{border-color:var(--coral);box-shadow:0 0 0 2px color-mix(in srgb,var(--coral) 18%,transparent)}
.themeSwatch{width:32px;height:32px;border-radius:10px;border:1px solid rgba(255,255,255,.18)}
.themeSwatch.purple{background:linear-gradient(135deg,#171022,#9b6cff)}
.themeSwatch.white{background:linear-gradient(135deg,#ffffff,#d9e0e8)}
.themeSwatch.black{background:linear-gradient(135deg,#050506,#34343a)}
.themeSwatch.blue{background:linear-gradient(135deg,#07101f,#4e8cff)}
@media(max-width:560px){.themeChoices{grid-template-columns:repeat(2,1fr)}}
...
<div id="login" class="login">
  <div class="loginShell">
    ...
    <section class="loginBrandPanel">
      <div>
        <div class="loginBrandTop">
          ...
          <div class="loginBrandName">freithcord</div>
        </div>
      ...
      <div class="loginSignature">freithcord · converse do seu jeito</div>
    </section>
    ...
    <section class="loginCard">
      ...
      <button id="loginBtn" class="btn primary">Entrar no freithcord</button>
...
<div id="appShell" class="app hubMode">
  <aside class="rail">
    <button id="homeHubBtn" class="serverIcon homeHubIcon active" type="button" title="Início do freithcord">
  ...
  <aside class="sidebar">
    <div class="sideHead">
      <div class="brand"><span class="brandDot"></span><span id="serverTitle" class="serverTitle">freithcord</span></div>
  ...
  <main class="main">
    <header class="topbar">
      <div class="topLeft">
        <div id="topTitle" class="topTitle">freithcord</div>
    ...
    <div class="content">
      <section id="homeView" class="view home">
        <div class="homeCard">
          ...
          <h1 id="welcomeTitle">Bem-vindo ao freithcord</h1>
      ...
      <section id="friendsView" class="view hidden">
        <div class="friendsHome">
          <div class="friendsHomeTop">
            <strong style="margin-right:8px;">freithcord</strong>
        ...
        <div class="serverSettings">
          ...
          <div class="settingsBody">
            ...
            <div id="settingsProfilePage" class="settingsPanel">
              ...
              <p>Personalize a identidade do seu servidor no freithcord.</p>
                ...
                <div>
                  ...
                  <div class="serverPreview">
                    ...
                    <div class="serverPreviewInner">
                      ...
                      <div id="serverPreviewDescription" class="serverPreviewDescription">Seu servidor no freithcord.</div>
            ...
            <div id="settingsMembersPage" class="settingsPanel hidden">
              <h2>Membros</h2>
              <p>Pessoas que estão online no freithcord agora.</p>
            ...
            <div id="settingsSecurityPage" class="settingsPanel hidden">
              ...
              <div class="settingsCard">
                <strong>Proteção do freithcord</strong>
            ...
            <div id="settingsDeletePage" class="settingsPanel hidden">
              ...
              <p>Essa ação remove o servidor e seus canais do freithcord.</p>
  ...
  <div class="sharePicker">
    <div class="sharePickerHead">
      <div class="sharePickerBrand">
        ...
        <div>
          <h2>Compartilhar no freithcord</h2>
    ...
    <div class="sharePickerFoot">
      O seletor final de tela, janela ou aba é uma área de segurança do navegador e não pode receber o tema do freithcord.
    </div>
  </div>
</div>
...
<div id="profileModalWrap" class="modalWrap hidden">
  <div class="modal">
    ...
    <div style="margin-top:16px;">
      <div style="color:var(--low);font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.07em;">Tema do freithcord</div>
      <div class="themeChoices" id="themeChoices">
        <button class="themeChoice" type="button" data-theme-choice="purple">
          <span class="themeSwatch purple"></span>
          <span>Roxo</span>
        </button>
        <button class="themeChoice" type="button" data-theme-choice="white">
          <span class="themeSwatch white"></span>
          <span>Branco</span>
        </button>
        <button class="themeChoice" type="button" data-theme-choice="black">
          <span class="themeSwatch black"></span>
          <span>Preto</span>
        </button>
        <button class="themeChoice" type="button" data-theme-choice="blue">
          <span class="themeSwatch blue"></span>
          <span>Azul</span>
        </button>
      </div>
    </div>
...
const state = {
  ...
  theme: localStorage.getItem('ecord-theme') || 'black',
  pendingTheme: null,
  servers: [],
...
const VALID_THEMES = ['purple','white','black','blue'];

function normalizeTheme(theme){
  return VALID_THEMES.includes(theme) ? theme : 'black';
}
...
function updateThemeChoiceUI(){
  const selected = normalizeTheme(state.pendingTheme || state.theme);

  document.querySelectorAll('[data-theme-choice]').forEach(button=>{
    button.classList.toggle(
      'active',
      button.dataset.themeChoice === selected
    );
  });
}

function selectProfileTheme(theme){
  state.pendingTheme = normalizeTheme(theme);
...
function openProfileModal(){
  ...
  state.pendingTheme = normalizeTheme(state.theme);
...
function saveProfile(){
  ...
  state.theme = normalizeTheme(state.pendingTheme || state.theme);
...
function setView(name){
  ...
  if(name==='home'){
    $('#topTitle').textContent = currentServer()?.name || 'freithcord';
...
function updateServerSettingsPreview(){
  ...
  $('#serverPreviewDescription').textContent =
    description || 'Seu servidor no freithcord.';
...
function openModal(type){
  ...
  const cfg = {
    ...
    friend:['Adicionar amigo','Digite exatamente o nome do seu amigo no freithcord.','Ex.: Davi'],
...
document.querySelectorAll('[data-theme-choice]').forEach(button=>{
  button.addEventListener('click',()=>{
    selectProfileTheme(button.dataset.themeChoice);
  });
});
...
socket.on('friend-lookup-result',result=>{
  if(!result?.ok){
    toast(result?.error || 'Essa pessoa não existe no freithcord');
  }
});
...
io.on('connection', socket => {
  ...
  socket.on('friend-request-send', ({ username }) => {
    ...
    if (!target) {
      socket.emit('friend-request-result',{
        ok:false,
        error:'Essa pessoa não existe no freithcord'
      });
      return;
    }
  ...
  socket.on('friend-lookup', ({ userId, username }) => {
    ...
    socket.emit('friend-lookup-result', profile && profile.id !== String(userId || '')
      ...
      : {ok:false,error:'Essa pessoa não existe no freithcord'}
    );
  });
  ...
  socket.on('assign-role', ({ serverId, roleId, username }) => {
    ...
    if (!targetProfile) {
      socket.emit('permission-error',{error:'Esse usuário não existe no freithcord'});
      return;
    }
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`freithcord rodando na porta ${PORT}`);
});
